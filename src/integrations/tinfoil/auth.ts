...
/**
 * Revoke the Tinfoil token family (RFC 7009) on disconnect. The backend always
 * answers 200 with the real outcome in `{ revoked }`, so a false flag is thrown
 * rather than silently passed as success.
 */
